...
public class ParticipateController {
    ...
    public ApiResponse <ParticipateDtoRes.orderByAsc> orderBy(@RequestParam(name = "filter",defaultValue = "createdate") String filter ,
        ...
        List<Participate> participate = participateService.LiveupParticipateList(filter , growRoomId);

        return ApiResponse.onSuccess(ParticipateConverter.orderByAscDto(participate));
